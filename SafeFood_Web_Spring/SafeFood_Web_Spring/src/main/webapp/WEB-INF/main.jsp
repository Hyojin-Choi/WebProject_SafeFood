...
<body>
			...
			<c:if test="${islogin eq 'isLogin'}">
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li id=logout><a href="Logout"><img width="20px"
								src="./img/사람.png">Logout</a></li>
					</ul>
				</div>
			</c:if>
		</div>
	...
	<ul class="nav navbar-nav navbar-right">
		<li class="active"><a href="announce" style="margin-right: 30px">공지사항
		</a></li>
		<li><a href="productInfo" style="margin-right: 30px">상품 정보</a></li>
	...
	<div class="main col-12" style="margin-left: 300px">
		...
		<div class="isotope-container row grid-space-10"
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="pdetail?code=20"><img width="200" class="center"
							alt="아카페라아메리카노" src="img/아카페라아메리카노.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="pdetail?code=7"><img width="200" class="center"
							alt="누크바" src="img/N45누크바.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="pdetail?code=8"><img width="200" class="center"
							alt="비비빅" src="img/비비빅.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="pdetail?code=11"><img width="200" class="center"
							alt="서울우유바나나" src="img/서울우유바나나.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="pdetail?code=6"><img width="200" class="center"
							alt="메로나" src="img/메로나.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="pdetail?code=2"><img width="200" class="center"
							alt="진라면컵매운맛" src="img/진라면컵매운맛.jpg"></a>
					</div>
				</div>
			</div>
		...
		<form action="Login" id="popForm" method="post">
			...
			<div>
				...
				<div style="margin-top: 20px">
					<button type="button" class="btn btn-gray btn-sm" id="check">로
						그 인</button>
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form action="SignUp" name="registerform" method="post"
					action="./register">
