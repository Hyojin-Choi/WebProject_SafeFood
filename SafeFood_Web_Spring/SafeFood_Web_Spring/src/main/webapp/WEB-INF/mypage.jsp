...
<!-- //(String id, String pw, String name, String addr, String email, String tel, String alinfo) -->
	...
	<div class="HMH" >
    <tr>
        <td><input type="button" class="btn btn-default btn-sm" value="회원 수정" onclick="updatemem()">
            <br /> <input type="button" class="btn btn-default btn-sm" value="회원 탈퇴" onclick="deletemem()"></td>
        <br />
        <input type="button" class="btn btn-default btn-sm" value="메인 화면 돌아가기" onclick="goMain()">
        </td>
    </tr>
    </div>
</body>
